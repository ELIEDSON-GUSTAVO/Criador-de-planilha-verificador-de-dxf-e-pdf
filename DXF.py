...
caminho_da_pasta = r"T:\17 - DXF\Engenharia"  # Use r"..." para lidar com barras invertidas
...
def verificar_codigos(codigos, caminho_da_pasta):
    ...
    # Lista apenas arquivos na pasta (sem diretórios) com extensão .dxf
    arquivos_na_pasta = [os.path.splitext(arquivo)[0] for arquivo in os.listdir(caminho_da_pasta) if arquivo.lower().endswith(".dxf")]
