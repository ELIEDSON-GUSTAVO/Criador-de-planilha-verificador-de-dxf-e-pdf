...
arquivo_excel = r"C:\Users\Eliedson.silva\Desktop\AUTOMAÇÕES DE PLANILHA - ELIEDSON GUS I LICENCE PRIV MIT\DADOS.xlsx"
...
def gerar_novo_excel(df_pecas, pedido_venda, arquivo_saida):
    ...
    for linha in pedido_venda:
        ...
        if maior_score > 85:  # Ajustado para permitir mais correspondências
            nome_item_correspondente = melhor_correspondencia['Nome do Item']
